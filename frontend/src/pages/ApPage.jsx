...
import { getPublicNews } from '../services/publicNews.js';
...
const ApPage = () => {
  ...
  useLiveRefresh(() => {
    void loadArticles();
  }, [selectedDate, selectedRegion, selectedDistrict], 5000);
    ...
    <main className="page">
      ...
      <section className="article-grid">
        ...
        {selectedDistrict && !loading && articles.length === 0 ? (
          <EmptyState title={t('common.noNewsForDate')} description="No district stories are available up to the selected date." />
        ) : null}
